...
We offer binary images of the latest releases here: [https://gitlab.ekata.io/baza-foundation/baz-token/releases](https://gitlab.ekata.io/baza-foundation/baz-token/-/releases#0.0.1.8)
